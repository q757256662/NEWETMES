<template>
  <div style="min-width:1300px;" class="app-container calendar-list-container">
    ...
    <div style="margin-bottom:10px">
      流水号：
      <el-input @keyup.enter.native="handleSearch" style="width: 200px;" class="filter-item" placeholder="输入流水号"
        v-model.number="listQuery.number"> </el-input>
    ...
    <el-table :data="tableData" v-loading.body="listLoading">
      ...
      <el-table-column label="操作">
        <template scope="scope">
          <!-- <el-tooltip class="item" effect="light" content="点击下载pod文件" placement="top"> -->
...
<script>
import { search, downLoad } from "api/admin/flowNumber/flowNumber";
export default {
  data() {
    return {
      tableData: [],
  ...
  methods: {
    ...
    handleSearch() {
      ...
      if (reg.test(this.listQuery.number)) {
        // console.log(this.listQuery.number)
